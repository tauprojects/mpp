package psy.lob.saw.synchrobench.skiplists.lockfree;
...
import psy.lob.saw.synchrobench.skiplists.RandomLevelGenerator;
...
public class NonBlockingJavaSkipListMap<K, V> extends AbstractMap<K, V>
	...
	private int randomLevel() {
		return RandomLevelGenerator.randomLevel();
	}
